#!/usr/bin/env python3
"""
Visualize Bingo prefetcher impact using stats from workspace/out_no_bingo and
workspace/out_bingo_l2. Generates a PNG with key metrics and prints a summary.
"""
import math
import os
...
def main():
    ...
    if not base_stats or not hwp_stats or not hwp_multi_stats:
        print("Missing stats. Run workspace/run_bingo_compare.sh first.")
        return
